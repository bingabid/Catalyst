...
from utils.utils import set_model, get_device, get_current_human_time, set_global_seed, print_model_summary, validate, accuracy, set_optimizer
...
def args_parser():
    ...
    parser.add_argument('--ood_eval', action='store_true', help='false for during training')
    ...
    parser.add_argument('--model', default='resnet', type=str, help='model architecture: [resnet18, resnet34, resnet101, densenet101]')
...
def build_related_dirs(args):
    ...
    for curr_dir in [model_checkpoint_directory]:
        os.makedirs(curr_dir, exist_ok=True)
    return model_checkpoint_directory
...
def main(args):
    ...
    model_checkpoint_directory = build_related_dirs(args)
